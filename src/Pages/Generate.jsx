      ...
      <div className="w-full bg-white/10 backdrop-blur-lg rounded-xl p-6 shadow-xl border border-gray-200/20">
        <form className="space-y-5" action="">
          <fieldset className="space-y-4">
            <label htmlFor="prompt" className="block text-sm font-medium text-gray-300 ml-1">
            ...
            <div className="relative">
              ...
              />
              <Image size={20} className="absolute right-3 top-3.5 text-gray-400" />
            </div>
            ...
            <button 
              className="w-full mt-6 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white font-medium py-3 px-4 rounded-lg transition-all duration-200 shadow-lg shadow-indigo-500/30 flex items-center justify-center gap-2"
            >
              <Sparkles size={16} />
              Generate
            </button>
